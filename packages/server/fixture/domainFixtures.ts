...
export const DEMO_LORE_FIXTURES = deepFreeze([
	...
	},
	{
		...
		createdAt: FIXTURE_TIMESTAMP,
		updatedAt: FIXTURE_TIMESTAMP,
		title: 'Fictional healthcare operations demo guidance',
		generatedTitle: '',
		summary: 'Administrative grounding rules for fictional operational workflows.',
		category: 'Other',
		type: METADATA_TYPES.LORE,
		source: 'repository-fixture',
		content:
			'Use only fictional operational evidence. Keep guidance administrative and exclude diagnosis, treatment, and medical advice.',
		characterIds: ['healthcare-operations-assistant_demo'],
		keywordList: ['fictional workflow', 'administration'],
		topicList: ['healthcare operations'],
		entityList: [],
		domain: 'healthcare_operations',
