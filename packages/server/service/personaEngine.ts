...
import { MemoryResponse, PersonaResponse } from '@rag-advisor-demo/shared/api';
import { CharacterInfo, ProfileInfo, AiModelInfo, ChatTurn } from '@rag-advisor-demo/shared/domain';
