import { ProfileResponse } from '@rag-advisor-demo/shared/api';
import { ApiError, ProfileCdo, ProfileInfo } from '@rag-advisor-demo/shared/domain';
import {
	buildProfileId,
	createBasicProfileInfo,
	isProfileInfo,
} from '@rag-advisor-demo/shared/util';
