...
description: Guide safe tooling, dependency, CI, package manager, TypeScript, Prettier, build, Docker, or workspace script upgrades in RAG Advisor Demo. Use when changing package.json scripts, pnpm versions, Turbo config, tsconfig files, CI workflows, Dockerfile, formatting, or dependency versions.
---
