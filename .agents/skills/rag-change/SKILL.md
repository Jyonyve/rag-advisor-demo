---
name: rag-change
description: Guide safe changes to RAG Advisor Demo RAG, LLM, prompt, memory, retrieval, structured-output, embedding, Chroma store, or AI model behavior. Use when modifying server/service, server/store retrieval logic, shared AI model config, prompt templates, schema parsing, or chat orchestration.
---
